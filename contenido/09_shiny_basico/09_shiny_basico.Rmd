...
En _fastbooks_ anteriores hemos visto bastantes utilidades para visualizar datos de manera interactiva: `plotly` para crear gráficos, `leaflet` para mapas, `R Markdown` para documentos y `flexdashboard` para cuadros de mando. En estos dos _fastbooks_ veremos cómo construir aplicaciones web interactivas directamente desde R, utilizando Shiny.
...
Este _fastbook_ viene acompañado de una carpeta de ejemplos, que deberás tener a mano para poder ejecutar las aplicaciones que iremos viendo.
