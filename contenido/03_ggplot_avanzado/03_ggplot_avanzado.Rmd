...
En los fastbooks 1 y 2 hemos visto cómo crear gráficos estáticos con ggplot, con diferentes geometrías (puntos, líneas, boxplots, barras, ...), escalas (numéricas continuas, categóricas, temporales, ...) y transformaciones estadísticas.

En este nuevo fastbook vamos a aprender a personalizar los gráficos ajustando el aspecto y a presentar datos geoespaciales sobre mapas.

## 1. Títulos, etiquetas y temas

Vamos a rescatar uno de los gráficos que hicimos en el anterior fastbook para personalizarlo.
...
![](resources/export_from_rstudio.png)

Y ahí podremos elegir varias opciones de exportación, como la ruta del fichero o el tamaño de la imagen.

Aunque podemos utilizar estas dos opciones para guardar los gráficos en disco, lo normal es que formen parte de un documento Rmarkdown y que lo exportemos junto a texto formateado a PDF, HTML u otros formatos. Profundizaremos sobre este tema en el fastbook dedicado a Rmarkdown.
