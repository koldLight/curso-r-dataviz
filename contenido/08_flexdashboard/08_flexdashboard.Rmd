...
Para seguir correctamente este fastbook, deberás tener instaladas las librerías `flexdashboard` y `DT`.

```{r}
# Descomenta las siguientes líneas en el caso de que no las tengas instaladas
...
![](resources/varias_paginas_menu.png)
