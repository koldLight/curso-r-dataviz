...
Hasta ahora hemos visto diferentes herramientas para crear visualizaciones sobre datos. En este fastbook, veremos cómo diseñar informes completos.
...
Para seguir correctamente este fastbook, deberás tener instaladas las librerías `rmarkdown` y `tinytex`.

```{r}
# Descomenta las siguiente líneas en el caso de que no las tengas instaladas
# install.packages("rmarkdown")
# install.packages("tinytex")
```

Además, este fastbook viene acompañado con una serie de ejemplos. Es recomendable que vayas viendo su código fuente y resultado mientras sigues cada uno de los apartados.
