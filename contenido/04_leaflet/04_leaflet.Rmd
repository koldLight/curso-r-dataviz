...
Durante el fastbook anterior vimos una introducción a los gráficos de mapas con ggplot2. En este, profundizaremos en la visualización de datos geoespaciales, y utilizaremos una herramienta especializada en ello: `leaflet`.
...
![proyeccion](resources/projection.gif)
...
# Si no lo tienes instalado, descomenta esta línea para hacerlo
