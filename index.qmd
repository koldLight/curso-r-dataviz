...
Este curso está disponible en GitHub, en [koldLight/curso-r-dataviz](https://github.com/koldLight/curso-r-dataviz). Para seguirlo, lo más recomendable es que te descargues el repositorio completo y sitúes el workspace de R en él. Así te funcionarán bien tanto los notebooks de quarto, como las rutas relativas para leer ficheros de datos en `dat/`.
...
El curso presupone que sabes manipular datos utilizando dplyr. Si no, puedes seguir este [tutorial](https://cran.r-project.org/web/packages/dplyr/vignettes/dplyr.html) antes.
